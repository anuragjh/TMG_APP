...
import com.example.material.viewmodel.RemoveUserViewModel
import com.google.accompanist.swiperefresh.SwipeRefresh
import com.google.accompanist.swiperefresh.rememberSwipeRefreshState

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun RemoveUsersScreen(
    className: String,
    viewModel: RemoveUserViewModel = hiltViewModel(),
    onBack: () -> Unit = {},
    onComplete: () -> Unit = {}
) {
    ...
    if (navigateToHome) {
        LaunchedEffect(Unit) {
            Toast.makeText(context, "Users removed from class", Toast.LENGTH_SHORT).show()
            onComplete()
        }
    }
                    ...
                    Button(
                        onClick = {
                            ...
                            viewModel.removeSelectedUsers(
                                ...
                                onError = { e ->
                                    println("Remove failed: ${e.localizedMessage}")
